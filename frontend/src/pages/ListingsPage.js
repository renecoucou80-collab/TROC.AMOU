...
import { Heart, ShoppingBag, Phone, Euro } from 'lucide-react';
            ...
            <div style={{
              ...
              {donations.map((donation) => (
                <div
                  ...
                  onClick={() => navigate(`/listings/donation/${donation.id}`)}
                  style={{
                    background: '#fff',
                    borderRadius: '20px',
                    overflow: 'hidden',
                ...
                >
                  {donation.photos && donation.photos.length > 0 && (
                    <div style={{
                      ...
                      background: '#f5f5f5',
                      display: 'grid',
                      gridTemplateColumns: donation.photos.length === 1 ? '1fr' : donation.photos.length === 2 ? '1fr 1fr' : '2fr 1fr 1fr',
                      gap: '4px',
                      aspectRatio: '4/3'
                    }}>
                      {donation.photos.map((photo, idx) => (
                        <div
                          ...
                          style={{
                            position: 'relative',
                            overflow: 'hidden',
                            gridRow: idx === 0 && donation.photos.length > 2 ? 'span 2' : 'auto'
                          }}
                        >
                          <img
                            src={photo}
